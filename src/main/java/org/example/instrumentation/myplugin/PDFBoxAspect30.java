...
public class PDFBoxAspect30 {
    @Pointcut(className = "org.apache.fontbox.ttf.HorizontalMetricsTable", methodName = "getLeftSideBearing",
            methodParameterTypes = {"int"}, timerName = "HorizontalMetricsTable - getLeftSideBearing")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.HorizontalMetricsTable.getLeftSideBearing");
