...
public class PDFBoxAspect62 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.PDFXRefStream", methodName = "getObject",
            methodParameterTypes = {"int"}, timerName = "PDFXRefStream - getObject")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdfparser.PDFXRefStream.getObject");
