...
public class PDFBoxAspect57 {
    @Pointcut(className = "org.apache.fontbox.ttf.VerticalMetricsTable", methodName = "getTopSideBearing",
            methodParameterTypes = {"int"}, timerName = "VerticalMetricsTable - getTopSideBearing")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.VerticalMetricsTable.getTopSideBearing");
