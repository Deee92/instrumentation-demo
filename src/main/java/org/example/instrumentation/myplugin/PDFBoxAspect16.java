...
public class PDFBoxAspect16 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isCR",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isCR")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/16-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/16-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/16-pdfbox-returned.xml";
