...
public class PureAspect37 {
    @Pointcut(className = "com.turn.ttorrent.client.CommunicationManager", methodName = "getExecutor",
            methodParameterTypes = {}, timerName = "CommunicationManager - getExecutor")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/37-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/37-returned.xml";
