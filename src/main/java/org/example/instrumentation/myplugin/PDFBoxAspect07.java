...
public class PDFBoxAspect07 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.interactive.digitalsignature.COSFilterInputStream", methodName = "inRange",
            methodParameterTypes = {}, timerName = "COSFilterInputStream - inRange")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/07-pdfbox-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/07-pdfbox-returned.xml";
