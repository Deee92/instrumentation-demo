...
public class PDFBoxAspect70 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceCMYK", methodName = "getDefaultDecode",
            methodParameterTypes = {"int"}, timerName = "PDDeviceCMYK - getDefaultDecode")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.color.PDDeviceCMYK.getDefaultDecode");
