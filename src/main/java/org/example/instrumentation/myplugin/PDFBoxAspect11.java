...
public class PDFBoxAspect11 {
    @Pointcut(className = "org.apache.pdfbox.filter.ASCIIHexFilter", methodName = "isEOD",
            methodParameterTypes = {"int"}, timerName = "ASCIIHexFilter - isEOD")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/11-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/11-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/11-pdfbox-returned.xml";
