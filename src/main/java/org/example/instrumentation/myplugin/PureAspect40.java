...
public class PureAspect40 {
    @Pointcut(className = "com.turn.ttorrent.client.AnnounceableInformationImpl", methodName = "getDownloaded",
            methodParameterTypes = {}, timerName = "AnnounceableInformationImpl - getDownloaded")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/40-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/40-returned.xml";
