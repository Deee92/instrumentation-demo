...
public class PureAspect44 {
    @Pointcut(className = "com.turn.ttorrent.network.AcceptAttachmentImpl", methodName = "isTimeoutElapsed",
            methodParameterTypes = {"java.lang.Object"}, timerName = "AcceptAttachmentImpl - isTimeoutElapsed")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/44-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/object-data/44-param.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/44-returned.xml";
