...
public class PDFBoxAspect28 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceGray", methodName = "toRGB",
            methodParameterTypes = {"float[]"}, timerName = "PDDeviceGray - toRGB")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.color.PDDeviceGray.toRGB");
