...
public class PDFBoxAspect23 {
    @Pointcut(className = "org.apache.pdfbox.util.SmallMap", methodName = "size",
            methodParameterTypes = {}, timerName = "SmallMap - size")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.util.SmallMap.size");
