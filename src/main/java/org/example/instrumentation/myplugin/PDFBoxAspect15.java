...
public class PDFBoxAspect15 {
    @Pointcut(className = "org.apache.fontbox.cff.CFFParser$RangeMapping", methodName = "isInRange",
            methodParameterTypes = {"int"}, timerName = "CFFParser$RangeMapping - isInRange")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/15-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/15-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/15-pdfbox-returned.xml";
