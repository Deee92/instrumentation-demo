...
public class PureAspect47 {
    @Pointcut(className = "com.turn.ttorrent.common.creation.HashingResult", methodName = "getSourceSizes",
            methodParameterTypes = {}, timerName = "HashingResult - getSourceSizes")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/47-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/47-returned.xml";
