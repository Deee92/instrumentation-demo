...
public class PDFBoxAspect47 {
    @Pointcut(className = "org.apache.pdfbox.util.Matrix", methodName = "getValues",
            methodParameterTypes = {}, timerName = "Matrix - getValues")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.util.Matrix.getValues");
