...
public class PDFBoxAspect38 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$2", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$2 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$2.blendChannel");
