...
public class PDFBoxAspect22 {
    @Pointcut(className = "org.apache.pdfbox.text.PDFTextStripper", methodName = "getPageStart",
            methodParameterTypes = {}, timerName = "PDFTextStripper - getPageStart")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/22-pdfbox-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/22-pdfbox-returned.xml";
