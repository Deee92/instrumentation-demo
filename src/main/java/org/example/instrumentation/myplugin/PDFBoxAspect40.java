...
public class PDFBoxAspect40 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$4", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$4 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$4.blendChannel");
