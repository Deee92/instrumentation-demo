...
public class PDFBoxAspect55 {
    @Pointcut(className = "org.apache.fontbox.cff.CharStringCommand$Key", methodName = "hashCode",
            methodParameterTypes = {}, timerName = "CharStringCommand$Key - hashCode")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.cff.CharStringCommand$Key.hashCode");
