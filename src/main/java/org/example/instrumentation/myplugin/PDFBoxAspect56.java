...
public class PDFBoxAspect56 {
    @Pointcut(className = "org.apache.fontbox.cff.CharStringCommand$Key", methodName = "equals",
            methodParameterTypes = {"java.lang.Object"}, timerName = "CharStringCommand$Key - equals")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.cff.CharStringCommand$Key.equals");
