...
public class PureAspect15 {
    @Pointcut(className = "com.turn.ttorrent.client.SharedTorrent", methodName = "getSeedersCount",
            methodParameterTypes = {}, timerName = "seeders count")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/15-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/15-returned.xml";
