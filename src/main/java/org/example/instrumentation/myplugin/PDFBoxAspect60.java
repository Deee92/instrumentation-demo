...
public class PDFBoxAspect60 {
    @Pointcut(className = "org.apache.pdfbox.filter.ASCII85InputStream", methodName = "skip",
            methodParameterTypes = {"long"}, timerName = "ASCII85InputStream - skip")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.filter.ASCII85InputStream.skip");
