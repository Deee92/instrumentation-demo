...
public class PDFBoxAspect20 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isClosing",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isClosing")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/20-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/20-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/20-pdfbox-returned.xml";
