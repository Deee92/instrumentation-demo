...
public class PureAspect39 {
    @Pointcut(className = "com.turn.ttorrent.client.CommunicationManager", methodName = "isRunning",
            methodParameterTypes = {}, timerName = "CommunicationManager - isRunning")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/39-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/39-returned.xml";
