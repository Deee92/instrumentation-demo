...
public class PureAspect22 {
    @Pointcut(className = "com.turn.ttorrent.common.creation.HashingResult", methodName = "getHashes",
            methodParameterTypes = {}, timerName = "hashes")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/22-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/22-returned.xml";
