...
public class PureAspect21 {
    @Pointcut(className = "com.turn.ttorrent.common.TorrentMetadataImpl", methodName = "getAnnounceList",
    ...
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/21-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/21-returned.xml";
