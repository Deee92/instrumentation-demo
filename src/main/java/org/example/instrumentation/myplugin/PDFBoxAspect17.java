...
public class PDFBoxAspect17 {
    @Pointcut(className = "org.apache.fontbox.cmap.CodespaceRange", methodName = "isFullMatch",
            methodParameterTypes = {"byte[]", "int"}, timerName = "CodespaceRange - isFullMatch")
    public static class PureMethodAdvice  implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.cmap.CodespaceRange.isFullMatch");
