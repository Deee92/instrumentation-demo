...
public class PDFBoxAspect26 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyfSimpleDescript", methodName = "getXCoordinate",
            methodParameterTypes = {"int"}, timerName = "GlyfSimpleDescript - getXCoordinate")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.GlyfSimpleDescript.getXCoordinate");
