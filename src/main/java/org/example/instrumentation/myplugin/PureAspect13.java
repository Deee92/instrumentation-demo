...
public class PureAspect13 {
    @Pointcut(className = "com.turn.ttorrent.common.PeerUID", methodName = "getTorrentHash",
            methodParameterTypes = {}, timerName = "peer uid torrent hash")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/13-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/13-returned.xml";
