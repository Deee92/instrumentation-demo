...
public class PureAspect55 {
    @Pointcut(className = "com.turn.ttorrent.common.Pair", methodName = "second",
            methodParameterTypes = {}, timerName = "Pair - second")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/55-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/55-returned.xml";
