...
public class PureAspect26 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.PeerMessage", methodName = "getType",
            methodParameterTypes = {}, timerName = "peer message type")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/26-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/26-returned.xml";
