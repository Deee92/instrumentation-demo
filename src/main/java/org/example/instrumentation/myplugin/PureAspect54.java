...
public class PureAspect54 {
    @Pointcut(className = "com.turn.ttorrent.common.Pair", methodName = "first",
            methodParameterTypes = {}, timerName = "Pair - first")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/54-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/54-returned.xml";
