...
public class PDFBoxAspect01 {
    @Pointcut(className = "org.apache.fontbox.util.BoundingBox", methodName = "contains",
            methodParameterTypes = {"float", "float"}, timerName = "BoundingBox - contains")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.util.BoundingBox.contains");
