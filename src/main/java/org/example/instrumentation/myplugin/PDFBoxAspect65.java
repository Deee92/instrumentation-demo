...
public class PDFBoxAspect65 {
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.IndexedTableModel", methodName = "getColumnName",
            methodParameterTypes = {"int"}, timerName = "IndexedTableModel - getColumnName")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.debugger.colorpane.IndexedTableModel.getColumnName");
