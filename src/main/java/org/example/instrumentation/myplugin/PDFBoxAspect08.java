...
public class PDFBoxAspect08 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.PDAbstractContentStream", methodName = "isOutside255Interval",
            methodParameterTypes = {"int"}, timerName = "PDAbstractContentStream - isOutside255Interval")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/08-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/08-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/08-pdfbox-returned.xml";
