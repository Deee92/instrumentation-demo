...
public class PureAspect34 {
    @Pointcut(className = "com.turn.ttorrent.client.Piece", methodName = "getSize",
            methodParameterTypes = {}, timerName = "Piece - getSize")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/34-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/34-returned.xml";
