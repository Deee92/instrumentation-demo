...
public class PDFBoxAspect10 {
    @Pointcut(className = "org.apache.fontbox.afm.AFMParser", methodName = "isEOL",
            methodParameterTypes = {"int"}, timerName = "AFMParser - isEOL")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/10-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/10-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/10-pdfbox-returned.xml";
