...
public class PDFBoxAspect52 {
    @Pointcut(className = "org.apache.fontbox.ttf.OpenTypeScript$1", methodName = "compare",
            methodParameterTypes = {"int[], int"}, timerName = "OpenTypeScript$1 - compare")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.OpenTypeScript$1.compare");
