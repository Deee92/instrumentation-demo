...
public class PDFBoxAspect27 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyfSimpleDescript", methodName = "getYCoordinate",
            methodParameterTypes = {"int"}, timerName = "GlyfSimpleDescript - getYCoordinate")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.GlyfSimpleDescript.getYCoordinate");
