...
public class PDFBoxAspect44 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$12", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$12 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$12.blendChannel");
