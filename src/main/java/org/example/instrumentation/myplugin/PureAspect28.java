...
public class PureAspect28 {
    @Pointcut(className = "com.turn.ttorrent.common.TorrentMetadataImpl", methodName = "getInfoHash",
            methodParameterTypes = {}, timerName = "torrent metadata info hash")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/28-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/28-returned.xml";
