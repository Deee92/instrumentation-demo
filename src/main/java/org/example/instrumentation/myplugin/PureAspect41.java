...
public class PureAspect41 {
    @Pointcut(className = "com.turn.ttorrent.client.CommunicationManager", methodName = "getTorrentLoader",
            methodParameterTypes = {}, timerName = "CommunicationManager - getTorrentLoader")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/41-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/41-returned.xml";
