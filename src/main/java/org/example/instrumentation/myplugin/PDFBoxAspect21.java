...
public class PDFBoxAspect21 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isSpace",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isSpace")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/21-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/21-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/21-pdfbox-returned.xml";
