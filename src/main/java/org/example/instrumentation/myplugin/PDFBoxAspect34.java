...
public class PDFBoxAspect34 {
    @Pointcut(className = "org.apache.pdfbox.util.Matrix", methodName = "getValue",
            methodParameterTypes = {"int, int"}, timerName = "Matrix - getValue")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.util.Matrix.getValue");
