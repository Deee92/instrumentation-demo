...
public class PDFBoxAspect45 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.font.PDCIDFontType0", methodName = "getFontBoxFont",
            methodParameterTypes = {}, timerName = "PDCIDFontType0 - getFontBoxFont")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.font.PDCIDFontType0.getFontBoxFont");
