...
public class PDFBoxAspect25 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyfSimpleDescript", methodName = "getEndPtOfContours",
            methodParameterTypes = {"int"}, timerName = "GlyfSimpleDescript - getEndPtOfContours")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.GlyfSimpleDescript.getEndPtOfContours");
