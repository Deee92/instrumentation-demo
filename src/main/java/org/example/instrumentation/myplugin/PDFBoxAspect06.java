...
public class PDFBoxAspect06 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isEndOfName",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isEndOfName")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/06-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/06-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/06-pdfbox-returned.xml";
