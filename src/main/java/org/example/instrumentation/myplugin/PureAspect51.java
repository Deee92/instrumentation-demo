...
public class PureAspect51 {
    @Pointcut(className = "com.turn.ttorrent.client.CommunicationManager", methodName = "getTorrentsStorage",
            methodParameterTypes = {}, timerName = "CommunicationManager - getTorrentsStorage")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/51-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/51-returned.xml";
