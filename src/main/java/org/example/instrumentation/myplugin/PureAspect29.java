...
public class PureAspect29 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage", methodName = "getInfoHash",
            methodParameterTypes = {}, timerName = "http info hash")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/29-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/29-returned.xml";
