...
public class PDFBoxAspect31 {
    @Pointcut(className = "org.apache.fontbox.ttf.PostScriptTable", methodName = "getName",
            methodParameterTypes = {"int"}, timerName = "PostScriptTable - getName")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.PostScriptTable.getName");
