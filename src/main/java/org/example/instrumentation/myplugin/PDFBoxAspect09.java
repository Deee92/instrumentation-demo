...
public class PDFBoxAspect09 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.PDPageContentStream", methodName = "isOutside255Interval",
            methodParameterTypes = {"int"}, timerName = "PDPageContentStream - isOutside255Interval")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/09-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/09-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/09-pdfbox-returned.xml";
