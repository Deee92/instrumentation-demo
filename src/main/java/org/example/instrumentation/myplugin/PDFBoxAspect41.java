...
public class PDFBoxAspect41 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$7", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$7 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$7.blendChannel");
