...
public class PDFBoxAspect04 {
    @Pointcut(className = "org.apache.fontbox.cmap.CMapParser", methodName = "isWhitespaceOrEOF",
            methodParameterTypes = {"int"}, timerName = "CMapParser - isWhitespaceOrEOF")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/04-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/04-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/04-pdfbox-returned.xml";
