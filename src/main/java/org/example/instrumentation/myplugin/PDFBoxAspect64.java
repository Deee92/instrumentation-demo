...
public class PDFBoxAspect64 {
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.DeviceNTableModel", methodName = "getColumnName",
            methodParameterTypes = {"int"}, timerName = "DeviceNTableModel - getColumnName")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.debugger.colorpane.DeviceNTableModel.getColumnName");
