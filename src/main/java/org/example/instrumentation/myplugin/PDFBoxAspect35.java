...
public class PDFBoxAspect35 {
    @Pointcut(className = "org.apache.fontbox.cff.CFFParser$Format3FDSelect", methodName = "getFDIndex",
            methodParameterTypes = {"int"}, timerName = "CFFParser$Format3FDSelect - getFDIndex")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.cff.CFFParser$Format3FDSelect.getFDIndex");
