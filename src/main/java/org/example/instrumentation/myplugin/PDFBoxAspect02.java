...
public class PDFBoxAspect02 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.encryption.AccessPermission", methodName = "isPermissionBitOn",
            methodParameterTypes = {"int"}, timerName = "AccessPermission - isPermissionBitOn")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/02-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/02-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/02-pdfbox-returned.xml";
