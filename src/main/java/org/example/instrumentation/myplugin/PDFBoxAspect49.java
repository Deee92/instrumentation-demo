...
public class PDFBoxAspect49 {
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.DeviceNTableModel", methodName = "getColumnClass",
            methodParameterTypes = {"int"}, timerName = "DeviceNTableModel - getColumnClass")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.debugger.colorpane.DeviceNTableModel.getColumnClass");
