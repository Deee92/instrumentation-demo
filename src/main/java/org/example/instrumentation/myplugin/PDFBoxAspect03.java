...
public class PDFBoxAspect03 {
    @Pointcut(className = "org.apache.pdfbox.debugger.flagbitspane.FieldFlag", methodName = "isFlagBitSet",
            methodParameterTypes = {"int", "int"}, timerName = "FieldFlag - isFlagBitSet")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/03-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/03-pdfbox-params.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/03-pdfbox-returned.xml";
