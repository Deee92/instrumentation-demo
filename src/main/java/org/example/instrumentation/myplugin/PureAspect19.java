...
public class PureAspect19 {
    @Pointcut(className = "com.turn.ttorrent.client.Handshake", methodName = "getPstrlen",
            methodParameterTypes = {}, timerName = "Pstrlen")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/19-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/19-returned.xml";
