...
public class PDFBoxAspect42 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$8", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$8 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$8.blendChannel");
