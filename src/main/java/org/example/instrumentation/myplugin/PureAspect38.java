...
public class PureAspect38 {
    @Pointcut(className = "com.turn.ttorrent.client.SharingPeer", methodName = "getTorrent",
            methodParameterTypes = {}, timerName = "SharingPeer - getTorrent")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/38-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/38-returned.xml";
