...
public class PDFBoxAspect43 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$9", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$9 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$9.blendChannel");
