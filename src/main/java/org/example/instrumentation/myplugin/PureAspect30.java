...
public class PureAspect30 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.udp.UDPAnnounceRequestMessage", methodName = "getInfoHash",
            methodParameterTypes = {}, timerName = "udp info hash")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/30-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/30-returned.xml";
