...
public class PDFBoxAspect63 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.PDPage$1", methodName = "accept",
            methodParameterTypes = {"org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation"}, timerName = "PDPage$1 - accept")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.PDPage$1.accept");
