...
public class PDFBoxAspect14 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isWhitespace",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isWhitespace")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/14-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/14-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/14-pdfbox-returned.xml";
