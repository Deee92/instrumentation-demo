...
public class PureAspect49 {
    @Pointcut(className = "com.turn.ttorrent.client.CommunicationManager", methodName = "getPeersStorage",
            methodParameterTypes = {}, timerName = "CommunicationManager - getPeersStorage")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/49-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/49-returned.xml";
