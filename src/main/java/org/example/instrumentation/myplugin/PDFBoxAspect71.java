...
public class PDFBoxAspect71 {
    @Pointcut(className = "org.apache.fontbox.ttf.KerningSubtable", methodName = "isHorizontalKerning",
            methodParameterTypes = {"boolean"}, timerName = "KerningSubtable - isHorizontalKerning")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.KerningSubtable.isHorizontalKerning");
