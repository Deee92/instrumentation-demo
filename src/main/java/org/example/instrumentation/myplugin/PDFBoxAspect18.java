...
public class PDFBoxAspect18 {
    @Pointcut(className = "org.apache.fontbox.ttf.VerticalMetricsTable", methodName = "getAdvanceHeight",
            methodParameterTypes = {"int"}, timerName = "VerticalMetricsTable - getAdvanceHeight")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.VerticalMetricsTable.getAdvanceHeight");
