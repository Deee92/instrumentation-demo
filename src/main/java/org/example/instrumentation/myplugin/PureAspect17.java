...
public class PureAspect17 {
    @Pointcut(className = "com.turn.ttorrent.client.peer.SharingPeer", methodName = "isChoked",
            methodParameterTypes = {}, timerName = "sharing peer choked")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/17-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/17-returned.xml";
