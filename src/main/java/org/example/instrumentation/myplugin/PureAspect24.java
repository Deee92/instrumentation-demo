...
public class PureAspect24 {
    @Pointcut(className = "com.turn.ttorrent.client.storage.FileStorage", methodName = "size",
            methodParameterTypes = {}, timerName = "file storage size")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/24-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/24-returned.xml";
