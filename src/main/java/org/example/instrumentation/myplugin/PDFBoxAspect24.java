...
public class PDFBoxAspect24 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyfSimpleDescript", methodName = "getFlags",
            methodParameterTypes = {"int"}, timerName = "GlyfSimpleDescript - getFlags")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.GlyfSimpleDescript.getFlags");
