...
public class PDFBoxAspect69 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDCalRGB", methodName = "getDefaultDecode",
            methodParameterTypes = {"int"}, timerName = "PDCalRGB - getDefaultDecode")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.color.PDCalRGB.getDefaultDecode");
