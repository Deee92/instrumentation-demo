...
public class PureAspect36 {
    @Pointcut(className = "com.turn.ttorrent.client.peer.SharingPeer", methodName = "getPoorlyAvailablePieces",
            methodParameterTypes = {}, timerName = "SharingPeer - getPoorlyAvailablePieces")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/36-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/36-returned.xml";
