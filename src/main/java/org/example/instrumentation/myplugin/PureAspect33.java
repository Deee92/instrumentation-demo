...
public class PureAspect33 {
    @Pointcut(className = "com.turn.ttorrent.client.AnnounceableInformationImpl", methodName = "getLeft",
            methodParameterTypes = {}, timerName = "AnnounceableInformationImpl - getLeft")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/33-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/33-returned.xml";
