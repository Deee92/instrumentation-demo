...
public class PureAspect20 {
    @Pointcut(className = "com.turn.ttorrent.client.AnnounceableInformationImpl", methodName = "getAnnounceList",
            methodParameterTypes = {}, timerName = "announce list")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/20-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/20-returned.xml";
