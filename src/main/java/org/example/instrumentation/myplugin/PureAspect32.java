...
public class PureAspect32 {
    @Pointcut(className = "com.turn.ttorrent.client.peer.SharingPeer", methodName = "getULRate",
            methodParameterTypes = {}, timerName = "SharingPeer - getULRate")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/32-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/32-returned.xml";
