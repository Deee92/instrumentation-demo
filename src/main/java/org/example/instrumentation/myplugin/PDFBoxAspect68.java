...
public class PDFBoxAspect68 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDCalGray", methodName = "getDefaultDecode",
            methodParameterTypes = {"int"}, timerName = "PDCalGray - getDefaultDecode")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.color.PDCalGray.getDefaultDecode");
