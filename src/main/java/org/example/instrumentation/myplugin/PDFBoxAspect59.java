...
public class PDFBoxAspect59 {
    @Pointcut(className = "org.apache.fontbox.ttf.HorizontalMetricsTable", methodName = "getAdvanceWidth",
            methodParameterTypes = {"int"}, timerName = "HorizontalMetricsTable - getAdvanceWidth")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.HorizontalMetricsTable.getAdvanceWidth");
