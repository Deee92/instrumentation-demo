...
public class PDFBoxAspect50 {
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.IndexedTableModel", methodName = "getColumnClass",
            methodParameterTypes = {"int"}, timerName = "IndexedTableModel - getColumnClass")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.debugger.colorpane.IndexedTableModel.getColumnClass");
