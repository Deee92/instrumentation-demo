...
public class PureAspect42 {
    @Pointcut(className = "com.turn.ttorrent.client.LoadedTorrentImpl", methodName = "getEventDispatcher",
            methodParameterTypes = {}, timerName = "LoadedTorrentImpl - getEventDispatcher")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/42-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/42-returned.xml";
