...
public class PDFBoxAspect37 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$1", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$1 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$1.blendChannel");
