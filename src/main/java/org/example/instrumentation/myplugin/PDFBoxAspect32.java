...
public class PDFBoxAspect32 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.font.PDCIDFontType0", methodName = "getCFFFont",
            methodParameterTypes = {}, timerName = "PDCIDFontType0 - getCFFFont")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.font.PDCIDFontType0.getCFFFont");
