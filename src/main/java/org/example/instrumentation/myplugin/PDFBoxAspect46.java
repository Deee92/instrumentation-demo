...
public class PDFBoxAspect46 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.XrefTrailerResolver", methodName = "getXrefTable",
            methodParameterTypes = {}, timerName = "XrefTrailerResolver - getXrefTable")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdfparser.XrefTrailerResolver.getXrefTable");
