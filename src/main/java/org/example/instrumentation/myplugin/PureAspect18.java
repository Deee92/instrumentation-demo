...
public class PureAspect18 {
    @Pointcut(className = "com.turn.ttorrent.tracker.TrackedTorrent", methodName = "getInfoHash",
            methodParameterTypes = {}, timerName = "tracked torrent info hash")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/18-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/18-returned.xml";
