...
public class PDFBoxAspect66 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.XrefTrailerResolver", methodName = "getXrefType",
            methodParameterTypes = {}, timerName = "XrefTrailerResolver - getXrefType")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdfparser.XrefTrailerResolver.getXrefType");
