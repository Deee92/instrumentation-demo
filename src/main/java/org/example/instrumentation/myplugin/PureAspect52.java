...
public class PureAspect52 {
    @Pointcut(className = "com.turn.ttorrent.network.WriteTask", methodName = "getListener",
            methodParameterTypes = {}, timerName = "WriteTask - getListener")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/52-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/52-returned.xml";
