...
public class PureAspect35 {
    @Pointcut(className = "com.turn.ttorrent.client.peer.SharingPeer", methodName = "isChoking",
            methodParameterTypes = {}, timerName = "SharingPeer - isChoking")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/35-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/35-returned.xml";
