...
public class PureAspect27 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.TrackerMessage", methodName = "getType",
            methodParameterTypes = {}, timerName = "tracker message type")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/27-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/27-returned.xml";
