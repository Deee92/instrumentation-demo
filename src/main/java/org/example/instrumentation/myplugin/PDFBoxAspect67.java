...
public class PDFBoxAspect67 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.XrefTrailerResolver", methodName = "getTrailer",
            methodParameterTypes = {}, timerName = "XrefTrailerResolver - getTrailer")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdfparser.XrefTrailerResolver.getTrailer");
