...
public class PureAspect8 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage", methodName = "getNumWant",
            methodParameterTypes = {}, timerName = "http num want")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/8-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/8-returned.xml";
