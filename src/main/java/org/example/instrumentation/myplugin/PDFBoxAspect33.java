...
public class PDFBoxAspect33 {
    @Pointcut(className = "org.apache.fontbox.cmap.CIDRange", methodName = "unmap",
            methodParameterTypes = {"int"}, timerName = "CIDRange - unmap")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.cmap.CIDRange.unmap");
