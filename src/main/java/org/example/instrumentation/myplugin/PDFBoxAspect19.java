...
public class PDFBoxAspect19 {
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser", methodName = "isLF",
            methodParameterTypes = {"int"}, timerName = "BaseParser - isLF")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/pdfbox-object-data/19-pdfbox-receiving.xml";
        private static final String parameterObjectFilePath = "/home/user/pdfbox-object-data/19-pdfbox-param.xml";
        private static final String returnedObjectFilePath = "/home/user/pdfbox-object-data/19-pdfbox-returned.xml";
