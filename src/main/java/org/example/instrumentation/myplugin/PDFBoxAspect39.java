...
public class PDFBoxAspect39 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$3", methodName = "blendChannel",
            methodParameterTypes = {"float, float"}, timerName = "BlendMode$3 - blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$3.blendChannel");
