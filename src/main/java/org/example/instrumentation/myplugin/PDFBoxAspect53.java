...
public class PDFBoxAspect53 {
    @Pointcut(className = "org.apache.fontbox.type1.Token", methodName = "toString",
            methodParameterTypes = {}, timerName = "OpenTypeScript$1 - toString")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.type1.Token.toString");
