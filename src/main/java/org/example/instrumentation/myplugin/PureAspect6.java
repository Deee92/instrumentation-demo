...
public class PureAspect6 {
    @Pointcut(className = "com.turn.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage", methodName = "canOmitPeerId",
            methodParameterTypes = {}, timerName = "http omit peer id")
    public static class PureMethodAdvice {
        ...
        private static final String receivingObjectFilePath = "/home/user/object-data/6-receiving.xml";
        private static final String returnedObjectFilePath = "/home/user/object-data/6-returned.xml";
