...
public class PDFBoxAspect54 {
    @Pointcut(className = "org.apache.pdfbox.debugger.ui.PageEntry", methodName = "toString",
            methodParameterTypes = {}, timerName = "PageEntry - toString")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.pdfbox.debugger.ui.PageEntry.toString");
