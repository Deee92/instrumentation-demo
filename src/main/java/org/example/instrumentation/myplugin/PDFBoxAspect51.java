...
public class PDFBoxAspect51 {
    @Pointcut(className = "org.apache.fontbox.ttf.KerningSubtable$PairData0Format0", methodName = "compare",
            methodParameterTypes = {"int[], int"}, timerName = "KerningSubtable$PairData0Format0 - compare")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static void setup() {
            ...
            String[] fileNames = AdviceTemplate.setUpFiles("org.apache.fontbox.ttf.KerningSubtable$PairData0Format0.compare");
